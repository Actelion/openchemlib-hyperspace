...
public class HyperspaceSynthonSpaceInitializationProcess extends AbstractHyperspaceProcess implements AbstractHyperspaceProcess.HasProgress {
    ...
    private volatile SynthonSpace space;
    public HyperspaceSynthonSpaceInitializationProcess(AbstractSearchProvider provider, String file) { this.file = file; }
    ...
    @Override public String getName() { return "Load substructure space: " + Path.of(file).getFileName(); }
    public SynthonSpace getSpace() { return space; }
