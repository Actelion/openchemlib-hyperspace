...
public class SynthonSetAccessor {
    ...
    public SynthonSetAccessor(RawSynthonSpace rawSynthonSpace) {
        this.downsampledSpace = null;
        this.synthonSpace = null;
        this.rawSpace = rawSynthonSpace;
    }
    ...
    public Map<Integer, List<SynthonSpace.FragId>> getSynthonSets(String reactionId) {
        ...
        if (rawSpace != null) {
            Map<Integer, List<SynthonSpace.FragId>> map = rawSpace.getFragmentSets(reactionId);
            return map == null ? Collections.emptyMap() : map;
        }
    ...
    public SynthonSpace.FragId findFragment(String reactionId, String fragmentId) {
        if (rawSpace != null) {
            return rawSpace.findFragment(reactionId, fragmentId);
        }
